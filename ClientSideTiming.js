...
$(window).load(function () {
  ...
  setTimeout(function () {
    ...
    if (performance.timing) {
      ...
      var clientSideTimingMarkup = "<div id='client-side-timing' class='client-side-timing'><div class='client-side-timing-result'><div class='client-side-timing-button' style='display: block;'><span class='number'>${Total}</span><span class='unit'> ms</span></div><div id='client-details' class='client-side-timing-popup'><div class='info'><span class='name'>Client-Side-Timing</span><br/><span class='server-time'>${LoadedDateTime}</span></div><div class='client-side-timing-output'><table class='client-side-timing-values'><thead><tr><th></th><th>duration (ms)</th><th class='time-from-start'>from start (ms)</th></tr></thead><tbody><tr><td class='label'>Loading this script</td><td id='time-to-load-script'></td><td></td></tr>{{tmpl($data) 'clientSideTimingResultsTemplate'}}</tbody></table></div></div></div></div>";
